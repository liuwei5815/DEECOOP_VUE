<!----------------------------templateManage 用户自定义修改  注意要与最下边对应的样式名称保持一致-------------------------------->
<template>
...
<script >
  ...
  //*******************************************************用户自定义修改 start ***************************************************************************
  import {
    listPageTemplate, //分页列表查询查询
    updateDisableTemplate, //启用禁用功能
    addTemplate, //新增功能
    updateTemplate, //修改功能
    exportExcelTemplates,//Excel导出
    deleteTemplates //批量删除功能
  } from '@/api/template'
  //*******************************************************用户自定义修改 end ***************************************************************************
  //按钮权限
  ...
  export default {
    ...
    methods: {
      ...
      changeState(item, index) {
        ...
        //ajax调用启用禁用后台方法
        //*******************************************************用户自定义修改 start ***************************************************************************
        updateDisableTemplate(item.id,item.isdisable )
        //*******************************************************用户自定义修改 end ***************************************************************************
          .then(res => {
        }).catch(err => {
          console.log(err)
      ...
      refreshTable() {
        ...
        that.$axios.all([
          //*******************************************************用户自定义修改 start ***************************************************************************
          listPageTemplate({...that.tempQuery,pageNo:that.pageNo})
          //*******************************************************用户自定义修改 end ***************************************************************************
...
<!----------------------------templateManage 用户自定义修改  注意要与最上边定义的样式名称保持一致-------------------------------->
