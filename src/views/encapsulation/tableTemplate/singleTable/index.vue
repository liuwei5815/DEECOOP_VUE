              ...
              },
              {
                ...
                _cellConfig: {
                  ...
                  componentConfig: {
                    ...
                    //color: '#009933',//设置el-progress组件背景色，设置为auto表示使用渐变色，渐变色起始为红色，结束色为亮绿色，类似手机电池充电
                    color: 'auto',//设置el-progress组件背景色，设置为auto表示使用渐变色，渐变色起始为红色，结束色为亮绿色，类似手机电池充电
