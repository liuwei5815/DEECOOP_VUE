      ...
      return {
        ...
        aboveTableConfig: {
          ...
          apiObj: {
            ...
            params: {fieldCode: 'code,name,spec,unitName,genreName,remark',isNeedNotInGenreSpare:'true',notInProductIds: "'"+this.initData.temp.prodId+"'"},
          },
          //自定义列
          customColumn: [//自定义列
        ...
        if(list){
          if(list.length>0){
            for(let i=0;i<list.length;i++){
              ...
              inDetail.bomId = this.initData.temp.bomId;
              inDetail.parentProdId = this.initData.temp.prodId;
              inDetail.pathId = this.initData.temp.pathId;
              inDetail.bomTreeId = this.initData.temp.id;
              inDetail.layer = this.initData.temp.layer;
              inDetail.isreplaceable = '1'
