  ...
  export default {
    ...
    methods: {
      ...
      dialogOpen(){
        ...
        //类型(客户,供应商)
        this.typeData.defaultSelected=[]
        this.typeData.defaultSelected.push(this.temp.type)

        //省直辖市
        this.provinceData.defaultSelected=[]
        if(this.temp.id1){
          this.provinceData.defaultSelected.push(this.temp.id1)
        }
        if(this.temp.id2){
          this.provinceData.defaultSelected.push(this.temp.id2)
        }
        if(this.temp.id3){
          this.provinceData.defaultSelected.push(this.temp.id3)
        }
        if(this.temp.id4){
          this.provinceData.defaultSelected.push(this.temp.id4)
        }
        if(this.temp.id5){
          this.provinceData.defaultSelected.push(this.temp.id5)
        }
        if(this.temp.id6){
          this.provinceData.defaultSelected.push(this.temp.id6)
        }
        if(this.temp.province){
          this.provinceData.defaultSelected.push(this.temp.province)
        }
